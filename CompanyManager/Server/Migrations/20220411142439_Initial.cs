        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomOfferPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CustomOfferTime = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentOffers_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentOffers_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentOffers_AppointmentId",
                table: "AppointmentOffers",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentOffers_OfferId",
                table: "AppointmentOffers",
                column: "OfferId");
