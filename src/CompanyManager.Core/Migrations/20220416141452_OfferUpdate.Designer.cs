...
namespace CompanyManager.Core.Migrations
{
    ...
    [Migration("20220416141452_OfferUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.AppointmentOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Consent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.OfferCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Photo", b =>
                {
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Appointment", b =>
                {
                    b.HasOne("CompanyManager.Core.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.AppointmentOffer", b =>
                {
                    b.HasOne("CompanyManager.Core.Models.Appointment", "Appointment")
                        .WithMany("AppointmentOffers")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CompanyManager.Core.Models.Offer", "Offer")
                        .WithMany("AppointmentOffers")
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Consent", b =>
                {
                    b.HasOne("CompanyManager.Core.Models.Customer", "Customer")
                        .WithOne("Consent")
                        .HasForeignKey("CompanyManager.Core.Models.Consent", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CompanyManager.Core.Models.Offer", b =>
                {
                    b.HasOne("CompanyManager.Core.Models.OfferCategory", "OfferCategory")
                        .WithMany("Offers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CompanyManager.Core.Models.ApplicationUser", null)
                        .WithMany()
